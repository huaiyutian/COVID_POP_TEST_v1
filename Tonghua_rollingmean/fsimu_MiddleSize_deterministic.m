...
function ydot = fsimu(T,theta,xdata,parpop,par_tau,MiddleSize)
...
%ydot=[HS(i),HLa(i),HIa(i),HLs(i),HLp(i),HI(i),HR(i),i]; % the daily obervations

ydot=[HS(:),HLa(:),HIa(:),HLs(:),HLp(:),HI(:),HR(:)];
